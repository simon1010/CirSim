...
#include "../../Export/Include/ComponentDialog.h"
...
const QMetaObject ComponentDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ComponentDialog.data,
      qt_meta_data_ComponentDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ComponentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Dialog"))
        return static_cast< Ui::Dialog*>(const_cast< ComponentDialog*>(this));
